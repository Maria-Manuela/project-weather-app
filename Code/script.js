...
async function todaysWeatherData(){
  ...
  if (cityName != "herning" && description === "Clear") {
    ...
    weatherIcon = `<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Herning_Kommune_byv%C3%A5ben.svg/1641px-Herning_Kommune_byv%C3%A5ben.svg.png="Herning"/>`;
